...
public class PT_asteroids_game_manager : MonoBehaviour {
    ...
    private PT_level_data_handler currentLevelHandler;
    ...
    {
        //reset lives to 3 
        in_lives = currentLevelHandler.in_lives;
        in_score = 0;
    ...
    public void RegisterLevel(PT_level_data_handler levelToRegister)
    {
        currentLevelHandler = levelToRegister;
    }
}
