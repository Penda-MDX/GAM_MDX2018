...
public class PT_Jellyfish_version3 : MonoBehaviour {
    ...
    private Vector3 V3_fixed_rotation = Vector3.zero;
    ...
    void Update()
    {
        ...
        if (xRotation != 0 || yRotation != 0)
        {
            ...
            transform.RotateAround(transform.position, Vector3.up, yRotation*fl_turnRate);
            transform.RotateAround(transform.position, Vector3.right, xRotation * fl_turnRate);
